...
#define SWITCH_MIN_JUMP_TABLE_SIZE \
  PARAM_VALUE (PARAM_SWITCH_MIN_JUMP_TABLE_SIZE)
#define SWITCH_MAX_JUMP_TABLE_SIZE \
  PARAM_VALUE (PARAM_SWITCH_MAX_JUMP_TABLE_SIZE)
#define MAX_JUMP_TABLE_SIZE\
  PARAM_VALUE (PARAM_MAX_JUMP_TABLE_SIZE)
#define SWITCH_MIN_JUMP_TABLE_DENSITY \
