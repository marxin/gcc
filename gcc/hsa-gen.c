...
static void
gen_hsa_unaryop_for_builtin_or_call (int opcode, gimple *stmt, hsa_bb *hbb)
{
...
gen_hsa_insns_for_call (gimple *stmt, hsa_bb *hbb)
{
  ...
  switch (DECL_FUNCTION_CODE (fndecl))
    ...
    case BUILT_IN_SQRT:
    case BUILT_IN_SQRTF:
      gen_hsa_unaryop_for_builtin_or_call (BRIG_OPCODE_SQRT, stmt, hbb);
      break;

    case BUILT_IN_TRUNC:
    case BUILT_IN_TRUNCF:
      gen_hsa_unaryop_for_builtin_or_call (BRIG_OPCODE_TRUNC, stmt, hbb);
      break;
    ...
    case BUILT_IN_COSF:
      gen_hsa_unaryop_for_builtin_or_call (BRIG_OPCODE_NCOS, stmt, hbb);
      break;

    case BUILT_IN_EXP2F:
      gen_hsa_unaryop_for_builtin_or_call (BRIG_OPCODE_NEXP2, stmt, hbb);
      break;

    case BUILT_IN_LOG2F:
      gen_hsa_unaryop_for_builtin_or_call (BRIG_OPCODE_NLOG2, stmt, hbb);
      break;

    case BUILT_IN_SINF:
      gen_hsa_unaryop_for_builtin_or_call (BRIG_OPCODE_NSIN, stmt, hbb);
      break;
