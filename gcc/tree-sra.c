...
struct access
{
  ...
  {
    if (pool == NULL)
      pool = new pool_allocator <access> ("SRA accesses", 16);
...
pool_allocator<struct access> *access::pool = NULL;
...
struct assign_link
{
  ...
  {
    if (pool == NULL)
      pool = new pool_allocator <assign_link> ("SRA links", 16);
...
pool_allocator<assign_link> *assign_link::pool = NULL;
