...
pool_allocator<ipcp_value<tree> > *ipcp_cst_values_pool = NULL;
pool_allocator<ipcp_value<ipa_polymorphic_call_context> >
  *ipcp_poly_ctx_values_pool = NULL;
pool_allocator<ipcp_value_source<tree> > *ipcp_sources_pool = NULL;
pool_allocator<ipcp_agg_lattice> *ipcp_agg_lattice_pool = NULL;
...
ipcp_driver (void)
{
  ...
  ipcp_cst_values_pool = new pool_allocator<ipcp_value<tree> >
    ("IPA-CP constant values", 32);

  ipcp_poly_ctx_values_pool =
    new pool_allocator<ipcp_value<ipa_polymorphic_call_context> >
      ("IPA-CP polymorphic contexts", 32);

  ipcp_sources_pool = new pool_allocator<ipcp_value_source<tree> >
    ("IPA-CP value sources", 64);

  ipcp_agg_lattice_pool = new pool_allocator<ipcp_agg_lattice>
