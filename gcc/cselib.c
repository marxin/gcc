...
static pool_allocator<elt_list> elt_list_pool ("elt_list", 10);
static pool_allocator<elt_loc_list> elt_loc_list_pool ("elt_loc_list", 10);
static pool_allocator<cselib_val> cselib_val_pool ("cselib_val_list", 10);
