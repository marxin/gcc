...
static pool_allocator<variable_info> *variable_info_pool = NULL;
...
static pool_allocator<constraint> *constraint_pool = NULL;
...
init_alias_vars (void)
{
  ...
  variable_info_pool = new pool_allocator<variable_info> ("Variable info pool",
							  30);
  constraint_pool = new pool_allocator<constraint> ("Constraint pool", 30);
