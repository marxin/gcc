...
struct queued_debug_insn_change
{
  ...
  {
    if (pool == NULL)
      pool = new pool_allocator <queued_debug_insn_change>
...
pool_allocator<queued_debug_insn_change> *queued_debug_insn_change::pool = NULL;
...
pass_cprop_hardreg::execute (function *fun)
{
  ...
  if (MAY_HAVE_DEBUG_INSNS)
	...
	if (bitmap_bit_p (visited, bb->index)
      ...
      queued_debug_insn_change::release_pool ();
    }
