...
static void
dump_gimple_debug (pretty_printer *buffer, gdebug *gs, int spc, dump_flags_t flags)
{
  switch (gs->subcode)
    {
...
static void
dump_gimple_omp_for (pretty_printer *buffer, gomp_for *gs, int spc, dump_flags_t flags)
{
  size_t i;
...
static void
dump_gimple_omp_block (pretty_printer *buffer, gimple *gs, int spc, dump_flags_t flags)
{
  if (flags & TDF_RAW)
...
static void
dump_gimple_omp_return (pretty_printer *buffer, gimple *gs, int spc, dump_flags_t flags)
{
  if (flags & TDF_RAW)
    {
...
dump_gimple_omp_atomic_store (pretty_printer *buffer,
			      gomp_atomic_store *gs, int spc, dump_flags_t flags)
{
  if (flags & TDF_RAW)
    {
      dump_gimple_fmt (buffer, spc, flags, "%G <%T>", gs,
...
static void
dump_gimple_mem_ops (pretty_printer *buffer, gimple *gs, int spc, dump_flags_t flags)
{
...
static void
dump_gimple_bb_header (FILE *outf, basic_block bb, int indent, dump_flags_t flags)
{
  if (flags & TDF_BLOCKS)
    {
      if (flags & TDF_LINENO)
...
static void
dump_phi_nodes (pretty_printer *buffer, basic_block bb, int indent, dump_flags_t flags)
{
  gphi_iterator i;
