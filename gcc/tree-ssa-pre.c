...
static pool_allocator<pre_expr_d> *pre_expr_pool = NULL;
...
static pool_allocator<bitmap_set> *bitmap_set_pool = NULL;
...
init_pre (void)
{
  ...
  pre_expr_pool = new pool_allocator<pre_expr_d> ("pre_expr nodes", 30);
  bitmap_set_pool = new pool_allocator<bitmap_set> ("Bitmap sets", 30);
  FOR_ALL_BB_FN (bb, cfun)
    {
