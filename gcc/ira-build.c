...
static pool_allocator<live_range> *live_range_pool = NULL;
static pool_allocator<ira_allocno> *allocno_pool = NULL;
static pool_allocator<ira_object> *object_pool = NULL;
...
{
  live_range_pool = new pool_allocator<live_range> ("live ranges", 100);
  allocno_pool = new pool_allocator<ira_allocno> ("allocnos", 100);
  object_pool = new pool_allocator<ira_object> ("objects", 100);
...
static pool_allocator <ira_allocno_pref> *pref_pool = NULL;
...
initiate_prefs (void)
{
  pref_pool = new pool_allocator <ira_allocno_pref> ("prefs", 100);
...
/* Pools for copies.  */
static pool_allocator<ira_allocno_copy> *copy_pool = NULL;
...
{
  copy_pool = new pool_allocator<ira_allocno_copy> ("copies", 100);
