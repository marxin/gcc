...
struct read_info_type
{
  ...
  {
    if (pool == NULL)
      pool = new pool_allocator <read_info_type> ("read_info_pool", 100);
...
pool_allocator<read_info_type> *read_info_type::pool = NULL;
...
struct insn_info_type
{
  ...
  {
    if (pool == NULL)
      pool = new pool_allocator <insn_info_type> ("insn_info_pool", 100);
...
pool_allocator<insn_info_type> *insn_info_type::pool = NULL;
...
struct dse_bb_info_type
{
  ...
  {
    if (pool == NULL)
      pool = new pool_allocator <dse_bb_info_type> ("bb_info_pool", 100);
...
pool_allocator<dse_bb_info_type> *dse_bb_info_type::pool = NULL;
...
struct group_info
{
  ...
  {
    if (pool == NULL)
      pool = new pool_allocator <group_info> ("rtx_group_info_pool", 100);
...
pool_allocator<group_info> *group_info::pool = NULL;
...
struct deferred_change
{
  ...
  {
    if (pool == NULL)
      pool = new pool_allocator <deferred_change> ("deferred_change_pool", 10);
...
pool_allocator<deferred_change> *deferred_change::pool = NULL;
...
dse_step7 (void)
{
  ...
  read_info_type::release_pool ();
  insn_info_type::release_pool ();
  dse_bb_info_type::release_pool ();
  group_info::release_pool ();
  deferred_change::release_pool ();
}
