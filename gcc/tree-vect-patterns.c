  ...
  if (dump_enabled_p ())
    {
      ...
      dump_gimple_stmt (OPTGROUP_VEC_NOTE, TDF_SLIM, pattern_stmt, 0);
    }
                               ...
                               tree *type_in, tree *type_out)
{
  ...
  *type_out = get_vectype_for_scalar_type (type);
  ...
  if (dump_enabled_p ())
    dump_gimple_stmt_loc (OPTGROUP_VEC_NOTE, vect_location, TDF_SLIM,
			  pattern_stmt, 0);
...
vect_recog_rotate_pattern (vec<gimple *> *stmts, tree *type_in, tree *type_out)
{
  ...
  *type_out = vectype;
  ...
  if (dump_enabled_p ())
    dump_gimple_stmt_loc (OPTGROUP_VEC_NOTE, vect_location,
			  TDF_SLIM, pattern_stmt, 0);
