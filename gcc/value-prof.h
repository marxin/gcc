...
enum hist_type
{
  ...
  HIST_TYPE_TOPN,	    /* Tries to identify the top N most frequently
			       used values.  */
  HIST_TYPE_MAX
};
...
bool instrument_indirect_call_p (gimple *stmt);
...
extern void gimple_gen_topn_profiler (histogram_value, unsigned, unsigned);
