...
static struct spec_list static_specs[] =
{
  ...
  INIT_STATIC_SPEC ("func_reorder_linker_plugin_file", &func_reorder_linker_plugin_file_spec),
  INIT_STATIC_SPEC ("func_reorder_linker_plugin_opt", &func_reorder_linker_plugin_opt),
