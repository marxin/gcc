			       ...
			       const struct gcc_options *opts_set)
{
  ...
  if (opts->x_s390_tune >= PROCESSOR_2097_Z10)
    {
      SET_OPTION_IF_UNSET (opts, opts_set, param_param_max_unrolled_insns,
			   100);
  ...
  SET_OPTION_IF_UNSET (opts, opts_set, param_param_max_pending_list_length,
		       256);
  /* values for loop prefetching */
  SET_OPTION_IF_UNSET (opts, opts_set, param_param_l1_cache_line_size, 256);
  SET_OPTION_IF_UNSET (opts, opts_set, param_param_l1_cache_size, 128);
  ...
  SET_OPTION_IF_UNSET (opts, opts_set, param_param_l2_cache_size, 1500);
  SET_OPTION_IF_UNSET (opts, opts_set,
		       param_param_prefetch_min_insn_to_mem_ratio, 2);
  SET_OPTION_IF_UNSET (opts, opts_set, param_param_simultaneous_prefetches, 6);

  /* Use the alternative scheduling-pressure algorithm by default.  */
  SET_OPTION_IF_UNSET (opts, opts_set, param_sched_pressure_algorithm, 2);
  SET_OPTION_IF_UNSET (opts, opts_set, param_param_min_vect_loop_bound, 2);
  ...
  if (opts->x_s390_tune >= PROCESSOR_2964_Z13)
    {
      ...
      SET_OPTION_IF_UNSET (opts, opts_set, param_param_max_inline_insns_auto,
			   80);
    }
