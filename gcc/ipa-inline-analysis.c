...
static pool_allocator<predicate> *edge_predicate_pool = NULL;
...
inline_summary_alloc (void)
{
  ...
  if (edge_predicate_pool == NULL)
    edge_predicate_pool = new pool_allocator<predicate> ("edge predicates", 10);
}
