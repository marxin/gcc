...
/* { dg-final { scan-ipa-dump "Semantic equality hit:s2->s1" "sem-equality"  } } */
/* { dg-final { scan-ipa-dump "Semantic equality hit:nsd_different_result2->nsd_different_result" "sem-equality"  } } */
/* { dg-final { scan-ipa-dump "Semantic equality hit:nsd->gcd" "sem-equality"  } } */
/* { dg-final { scan-ipa-dump "Equal functions: 3" "sem-equality"  } } */
