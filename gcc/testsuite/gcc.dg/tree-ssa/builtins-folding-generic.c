...
const char global_1[10] = "abcdefghijklmnopqrstuvwxyz"; /* { dg-warning "initializer-string for array of chars is too long" } */ 
const char global_2[15] = "abxxxxxxxxxxxxxxxxxxxxxxxx"; /* { dg-warning "initializer-string for array of chars is too long" } */
...
main (void)
{
  ...
  if (__builtin_strncmp ("aab", "aac", 2) != 0)
    __builtin_abort ();
  if (__builtin_strncmp (global_1, global_2, 2) != 0)
    __builtin_abort ();
  if (__builtin_strncmp (global_1, global_2, 3) >= 0)
    __builtin_abort ();
  ...
  if (__builtin_strncasecmp ("aab", "aac", 2) != 0)
    __builtin_abort ();
  if (__builtin_strncasecmp (global_1, global_2, 2) != 0)
    __builtin_abort ();
